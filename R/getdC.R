...
#' @export
getdC <- function(logit.E,S0=S0.w, S1plus=S1plus.w, nages=nages.w, AgeMat=AgeMat.w, lambdaMax=lambdaMax.w, K1plus=K1plus.w, z=z.w){
  ...
  P0 <- NPROut$P1r
  Fec0 <- 1.0/N0
  fmax <- getFecmax2(lambdaMax = lambdaMax,S0 = S0,S1plus = S1plus,AgeMat = AgeMat)
  A <- (fmax - Fec0) / Fec0
