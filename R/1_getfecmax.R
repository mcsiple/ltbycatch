...
#' @details Parts of this derivation can be found in Breiwick et al. (1984) and Butterworth and Punt (1992). IMPORTANT: when applying this calculation, use AgeMat, and when defining probability of giving birth you use parturition ages (age at maturity + one year)
#' @param S0 calf/pup survival, a numeric value between 0 and 1
#' @param lambdaMax Maximum population growth rate (a numeric value)
